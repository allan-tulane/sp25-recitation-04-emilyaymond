...
Because of the parallel implementation, multiple processes can try to update counts[term] simultaneously which will lead to a race condition and inconsistent results.
